...
//    double[] score = {50.12, 42.5, 110, 33, 10, 74, 22, 18, 79, 20};//图表的数据点
    ...
    private final String URL = "http://www.buildworld.xyz/onenet/getHum.php";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //api_key
        savedApiKey = Preferences.getInstance(getActivity()).getString(Preferences.API_KEY,null);

        OneNetApi.setAppKey(savedApiKey);

        //获取数据
        getHumidityData(saveDeviceNum);
...
//        setTimer();
    ...
    //获取数据的方法
    private void getHumidityData(String saveDeviceNum) {
        Map<String,String> map = new HashMap<String, String>();
        //设置我们要查询的数据流的名称
        map.put("datastream_id","humidity");
        map.put("limit","20");
        OneNetApi.queryDataPoints(saveDeviceNum, map, new OneNetApiCallback() {
            ...
            public void onSuccess(String response) {
                ...
                System.out.println("数据值的数组："+Arrays.toString(date));
